...
<body  style="margin:10;background-color:white">
            ...
            <div class=" offset-2 col-8">
                <div class="card btn-secondary" >
                    <div class="card-header" style="background-color:#5A6268; ">
                        <h4 style="background-color: #5A6268;" class="card-title text-black"> <center>Update Account</center> </h4>
                    </div>
                    <div style="margin: 20px;"></div>
                    <form class="form-inline" method="POST" action="/staff/update_accounts" id="form-validation">
                      @csrf 
    ...
    <form action="/staff/update_account" method="post" >
        @csrf
